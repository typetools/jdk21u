...
public interface Map<K, V> {
    ...
    interface Entry<K, V> {
        ...
        @SideEffectFree
        public static <K extends @NonNull Object, V extends @NonNull Object> Map.@Unmodifiable Entry<K, V> copyOf(Map.@UnknownModifiability Entry<? extends K, ? extends V> e) {
