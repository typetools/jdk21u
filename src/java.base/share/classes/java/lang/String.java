...
public final class String
    ...
    public @Unique String(Charset charset, @PolySigned byte @GuardSatisfied [] bytes, @IndexOrHigh({"#1"}) int offset, @LTLengthOf(value={"#1"}, offset={"#2 - 1"}) @NonNegative int length) {
        if (length == 0) {
            this.value = "".value;
            this.coder = "".coder;
